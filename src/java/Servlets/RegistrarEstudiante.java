                ...
                if(sesion.getAttribute("usuario")!= null){
                    ...
                    if(id_rol==1){//Admin
                        if(Validacion.Validarcorreo(correo) && Validacion.ValidarBoleta(bol) && Validacion.Validarnombre(nombre)){
                            ...
                            boolean registrar= ControlUsuario.RegistrarEstudiante(nuevo);
                            if(registrar){
                                out.println("<script>");
                                    out.println("Swal.fire({");
                                        out.println("icon: 'success',");
                                        out.println("title: 'Correcto',");
                                        out.println("text: 'Se ha registrado el usuario'");
                                    out.println(" });");
                                out.println("</script>");
                            }else{
                                out.println("<script>");
                                    out.println("Swal.fire({");
                                        ...
                                        out.println("text: 'La boleta  o el correo ya esta registrados'");
                                    out.println(" });");
                                out.println("</script>");
                            }
                        }else{
