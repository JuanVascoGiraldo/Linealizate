...
<body>
  ...
  <div class="modal" id="modalR1">
    <div class="card">
        <form action="" name="">
            <label for="" class="article">Cambiar Contrase̱a</label><br>
            <br>
            <hr class="linea">
            <br>
            <label for="" class="article">Ingresa tu nueva contrase̱a</label><br>
            <input type="password" name="password" id="password" class ="input" required>
            <br>
            <label for="" class="article">Confirma tu nueva contrase̱a</label><br>
